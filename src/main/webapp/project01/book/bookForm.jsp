...
<jsp:include page="../projectHeader.jsp"/>
    ...
    <h1>전시회 예약</h1>
    <form action="bookPro.jsp?exhibit_number=<%=exhibit.getExhibit_number()%>" method="post" onsubmit="return reservationCheck()"><br>
    ...
    <script>
        ...
        function updateTimeSlots() {
            ...
            xhr.send("exhibit_number=<%= num %>&date=" + date);
        }
    </script>
